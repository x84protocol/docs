...
flowchart TB
    subgraph Server["Your Server"]
        A2A["A2A Endpoint<br/>(Express)"] --> Verify["x402 Verify<br/>(SDK)"] --> Logic["Agent Logic<br/>(any LLM)"]
    end
...
The key difference: your service endpoint points to **your own server**, not `a2a.x84.ai`.
